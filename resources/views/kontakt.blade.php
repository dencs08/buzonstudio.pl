    ...
    <body class="antialiased">
        ...
        <section id="landing-page">
            <div class="container landing-page-content">
                ...
                <h2 class="mb-5">
                    Powiedz nam co jest dla Ciebie najważniejsze.
                </h2>
        ...
        <section id="Contact">
            ...
            <div class="contact-buttons">
                <button class="btn btn-primary mx-2">Chcę porozmawiać!</button>
                <button class="btn btn-primary mx-2">Strona Internetowa</button>
                <button class="btn btn-primary mx-2">Aplikacja</button>
                <button class="btn btn-primary mx-2">Branding</button>
            </div>
